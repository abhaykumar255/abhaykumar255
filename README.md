...
### 🚀 Backend Engineer | Distributed Systems | Microservices | Cloud-Native Architectures

I'm a backend software engineer with 2+ years of experience building **high-scale distributed systems**, **event-driven microservices**, and **low-latency APIs** using Java, Spring Boot, Kafka, PostgreSQL, Redis, MongoDB, and AWS.
...
- CI/CD pipelines, microservice deployments
...
**Tools:** Git, Gradle, Maven, GitHub Actions  
**Monitoring:** Zipkin, Elasticsearch, Actuator  
